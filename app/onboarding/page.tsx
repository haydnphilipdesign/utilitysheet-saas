                                        ...
                                        <div className="flex gap-3">
                                            {['#10b981', '#3b82f6', '#8b5cf6', '#f59e0b', '#ef4444'].map((color) => (
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-full border-2 transition-all ${primaryColor === color ? 'border-foreground scale-110' : 'border-transparent'
                                                        }`}
                                            ...
                                            <input
                                                ...
                                                className="w-10 h-10 rounded-full bg-background border-none cursor-pointer p-0"
                                            />
                                        </div>
                                    </div>
                                </CardContent>
