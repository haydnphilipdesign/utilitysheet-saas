...
export const ADVANCED_MODULE_FIELD_METADATA: Record<AdvancedModuleKey, AdvancedModuleFieldMeta[]> = {
    lawn_exterior: [
        { key: 'lawn_care_provider_name', label: 'Lawn Care Provider', sellerPrompt: 'Who handles lawn care?', example: 'GreenScape Lawn' },
        { key: 'lawn_care_provider_phone', label: 'Lawn Care Phone', sellerPrompt: 'What is the lawn care phone number?', example: '(555) 123-4567' },
        { key: 'lawn_care_provider_email', label: 'Lawn Care Email', sellerPrompt: 'What is the lawn care email?', example: 'service@example.com' },
        { key: 'snow_removal_provider_name', label: 'Snow Removal Provider', sellerPrompt: 'Who handles snow removal?', example: 'Peak Winter Services' },
        { key: 'snow_removal_provider_phone', label: 'Snow Removal Phone', sellerPrompt: 'What is the snow removal phone number?', example: '(555) 987-6543' },
    ...
    irrigation_seasonal_controls: [
        ...
        { key: 'irrigation_provider_name', label: 'Irrigation Provider', sellerPrompt: 'Who services irrigation?', example: 'BlueSprinkler Co.' },
        { key: 'irrigation_provider_phone', label: 'Irrigation Phone', sellerPrompt: 'What is the irrigation phone number?', example: '(555) 222-3344' },
    ...
    service_providers: [
        { key: 'hvac_provider_name', label: 'HVAC Provider', sellerPrompt: 'Who services HVAC?', example: 'Comfort Air' },
        { key: 'hvac_provider_phone', label: 'HVAC Phone', sellerPrompt: 'What is the HVAC phone number?', example: '(555) 300-1000' },
        { key: 'pest_control_provider_name', label: 'Pest Control Provider', sellerPrompt: 'Who handles pest control?', example: 'SafeHome Pest' },
        { key: 'pest_control_provider_phone', label: 'Pest Control Phone', sellerPrompt: 'What is the pest control phone number?', example: '(555) 300-2000' },
        { key: 'plumber_provider_name', label: 'Plumber', sellerPrompt: 'Who is the usual plumber?', example: 'Rapid Rooter' },
        { key: 'plumber_provider_phone', label: 'Plumber Phone', sellerPrompt: 'What is the plumber phone number?', example: '(555) 300-3000' },
...
export const ADVANCED_MODULE_METADATA: Record<AdvancedModuleKey, AdvancedModuleMeta> = {
    lawn_exterior: {
        ...
        summary: 'Outdoor care details for lawn and snow handoff.',
        sellerAsks: 'Seller can provide lawn and snow provider contacts plus seasonal notes.',
        outputImpact: 'Included fields appear in the Lawn & Exterior section of the packet.',
    ...
    irrigation_seasonal_controls: {
        ...
        summary: 'Irrigation schedule and seasonal setup details.',
        sellerAsks: 'Seller can share irrigation provider contact, watering days, season timing, and notes.',
        outputImpact: 'Included fields appear in the Irrigation & Seasonal Controls section of the packet.',
        fields: ADVANCED_MODULE_FIELD_METADATA.irrigation_seasonal_controls,
    },
    mailbox_access: {
        key: 'mailbox_access',
        label: ADVANCED_MODULE_LABELS.mailbox_access,
        summary: 'Access details for mailbox, parking, and key utility shutoffs.',
        sellerAsks: 'Seller can provide mailbox, parking, breaker panel, and water shutoff locations.',
        outputImpact: 'Included fields appear in the Mailbox & Access section of the packet.',
    ...
    smart_home_security: {
        ...
        summary: 'Connected home and security device handoff details.',
        sellerAsks: 'Seller can provide device brands and setup transfer notes.',
        outputImpact: 'Included fields appear in the Smart Home & Security section of the packet.',
        fields: ADVANCED_MODULE_FIELD_METADATA.smart_home_security,
    },
    service_providers: {
        key: 'service_providers',
        label: ADVANCED_MODULE_LABELS.service_providers,
        summary: 'Recurring home service providers and contact details.',
        sellerAsks: 'Seller can provide HVAC, pest, and plumbing contacts plus notes.',
        outputImpact: 'Included fields appear in the Service Providers section of the packet.',
