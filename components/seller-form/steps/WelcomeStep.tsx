...
export function WelcomeStep({ address, onNext }: WelcomeStepProps) {
    return (
        ...
        >
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-slate-500/20 to-slate-600/10 flex items-center justify-center ring-1 ring-border backdrop-blur-md">
