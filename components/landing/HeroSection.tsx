...
function Hero3DCard() {
    return (
        <div
            className="relative w-full max-w-4xl mx-auto h-[540px] rounded-xl bg-card/50 border border-border backdrop-blur-sm shadow-2xl shadow-emerald-500/10 flex items-center justify-center p-2"
        >
            <div
